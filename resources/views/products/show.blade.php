            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach($sr->ProductVariantPrice as $pvc)
    ...
    <div class="card-footer">
        <div class="row justify-content-between">
            <div class="col-md-6">
                ...
                <p>
                    Showing {{($searchResults->currentpage()-1)*$searchResults->perpage()+1}} to {{$searchResults->currentpage()*$searchResults->perpage()}}
                    of {{$searchResults->total()}} entries
                </p>
            </div>
            <div class="col-md-2">
                {{$searchResults->links()}}
